...
?>
  ...
  <div class="form-group">
    <label for="inputAddress">Tangal Pelaksana</label>
    <input type="date" name="tgl_pelaksana" class="form-control form_date" id="form_date" >
  </div>
  <div class="form-group">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <select id="inputState" class="form-control" name="kota">
        ...
        <option selected value="Kota Tangerang">Kota Ciledug</option>
